!function (t, e) {
    ...
    return function (t) {
        ...
        function p(t, e, i) {
            if (t && e) if (t.forEach && t.forEach === O) t.forEach(e, i); else if (t.length === +t.length) for (var n = 0, a = t.length; a > n; n++) e.call(i, t[n], n, t); else for (var o in t) t.hasOwnProperty(o) && e.call(i, t[o], o, t)
        }
        ...
        var D, P = i(16), k = {
            ...
            }, z = Object.prototype.toString, R = Array.prototype, O = R.forEach, E = R.filter, V = R.slice, N = R.map, B = R.reduce,
            G = {
                inherits: c,
                mixin: d,
                clone: n,
	 ...
	 */
        var m = i(112), v = i(78), y = i(28), x = i(113), _ = i(10), w = i(13), b = i(54), M = i(25), S = i(3), A = i(67),
            I = i(1), T = i(22), C = i(15), L = i(21), D = I.each, P = ["echarts", "chart", "component"],
        ...
        var V = [], N = {}, B = [], G = {}, F = [], W = {}, H = {}, Z = {}, q = {}, j = new Date - 0, U = new Date - 0,
            X = "_echarts_instance_", Y = {version: "3.1.7", dependencies: {zrender: "3.0.8"}};
        ...
        function d(t, e, i, n, a) {
            var o = t ? "Update" : "", r = n && n.getShallow("animationDuration" + o),
        ...
        l.createNameEach = function (t, e) {
            ...
            getDataParams: function (t) {
                var e = this.getData(), i = this.seriesIndex, n = this.name, a = this.getRawValue(t), o = e.getRawIndex(t),
                    r = e.getName(t, !0), s = this.getRawDataArray(), l = s && s[o];
                return {
        ...
        n.prototype = {
            constructor: n, union: function (t) {
                ...
                var e = this, i = e.x, n = e.x + e.width, a = e.y, o = e.y + e.height, r = t.x, s = t.x + t.width, l = t.y,
                    h = t.y + t.height;
        ...
        function h(t, e) {
            ...
            var i = d.parseDate(e), n = i.getFullYear(), a = i.getMonth() + 1, o = i.getDate(), r = i.getHours(),
        ...
        var a = i(1), o = i(8), r = i(4), s = i(9), l = r.parsePercent, h = a.each, u = {},
        ...
        u.box = n, u.vbox = a.curry(n, "vertical"), u.hbox = a.curry(n, "horizontal"), u.getAvailableSize = function (t, e, i) {
            ...
            var n = e.width, a = e.height, r = l(t.left, n), h = l(t.top, a), u = l(t.right, n), c = l(t.bottom, a),
                d = l(t.width, n), f = l(t.height, a), p = i[2] + i[0], g = i[1] + i[3], m = t.aspect;
        ...
        (function (e) {
            ...
            var o = "undefined", r = "undefined" == typeof window ? e : window,
                s = typeof r.Float64Array === o ? Array : r.Float64Array, l = typeof r.Int32Array === o ? Array : r.Int32Array,
                h = {"float": s, "int": l, ordinal: Array, number: Array, time: Array}, u = i(12), c = i(52), d = i(1), f = i(7),
                p = d.isObject, g = ["stackedOn", "_nameList", "_idList", "_rawData"], m = function (t, e, i) {
            ...
            y.type = "list", y.getDimension = function (t) {
                ...
                t = t || [], this._rawData = t;
                var n = this._storage = {}, a = this.indices = [], o = this.dimensions, r = t.length, s = this._dimensionInfos,
                    l = [], u = {};
                e = e || [];
        ...
        function i(t) {
            var e = {}, i = {}, n = t.match(/Web[kK]it[\/]{0,1}([\d.]+)/), a = t.match(/(Android);?[\s\/]+([\d.]+)?/),
                o = t.match(/(iPad).*OS\s([\d_]+)/), r = t.match(/(iPod)(.*OS\s([\d_]+))?/),
                s = !o && t.match(/(iPhone\sOS)\s([\d_]+)/), l = t.match(/(webOS|hpwOS)[\s\/]([\d.]+)/),
                ...
                _ = t.match(/MSIE\s([\d.]+)/) || t.match(/Trident\/.+?rv:(([\d.]+))/), w = t.match(/Edge\/([\d.]+)/);
        ...
        var h = {}, u = 0, c = 5e3, d = i(1), f = i(8), p = {
            getWidth: n, getBoundingRect: a, adjustTextPositionOnRect: o, ellipsis: r, measureText: function (t, e) {
                var i = d.getContext();
        ...
        function s(t, e, i, a, o, r) {
            var s = a + 3 * (e - i) - t, l = 3 * (i - 2 * e + t), h = 3 * (e - t), u = t - o, c = l * l - 3 * s * h,
            ...
            if (n(c) && n(d)) if (n(l)) r[0] = 0; else {
                ...
                if (n(m)) {
                    ...
                    var I = (2 * c * l - 3 * s * d) / (2 * w(c * c * c)), T = Math.acos(I) / 3, C = w(c), L = Math.cos(T),
                        g = (-l - 2 * C * L) / (3 * s), y = (-l + C * (L + S * Math.sin(T))) / (3 * s),
        ...
        function h(t, e, i, n, a, o) {
            var r = (e - t) * a + t, s = (i - e) * a + e, l = (n - i) * a + i, h = (s - r) * a + r, u = (l - s) * a + s,
                c = (u - h) * a + h;
        ...
        var v = i(5), y = v.create, x = v.distSquare, _ = Math.pow, w = Math.sqrt, b = 1e-8, M = 1e-4, S = w(3), A = 1 / 3,
            I = y(), T = y(), C = y();
        t.exports = {
            cubicAt: o,
            cubicDerivativeAt: r,
        ...
        var i = "undefined" == typeof Float32Array ? Array : Float32Array, n = {
            create: function () {
                ...
                var n = e[0] * i[0] + e[2] * i[1], a = e[1] * i[0] + e[3] * i[1], o = e[0] * i[2] + e[2] * i[3],
        ...
        function u(t) {
            var e = (parseFloat(t[0]) % 360 + 360) % 360 / 360, n = r(t[1]), a = r(t[2]),
                o = .5 >= a ? a * (n + 1) : a + n - a * n, l = 2 * a - o,
        ...
        function g(t, e, n) {
            if (e && e.length && t >= 0 && 1 >= t) {
                var o = t * (e.length - 1), r = Math.floor(o), s = Math.ceil(o), u = h(e[r]), c = h(e[s]), d = o - r,
        ...
        h.getScaleExtent = function (t, e) {
            ...
            var i = t.scale, n = h.getScaleExtent(t, e), a = null != (e.getMin ? e.getMin() : e.get("min")),
        ...
        var n = i(3), a = i(8), o = n.extendShape({
            ...
            type: "pin", shape: {x: 0, y: 0, width: 0, height: 0}, buildPath: function (t, e) {
                var i = e.x, n = e.y, a = e.width / 5 * 3, o = Math.max(a, e.height), r = a / 2, s = r * r / (o - r),
                    l = n - o + r + s, h = Math.asin(s / r), u = Math.cos(h) * r, c = Math.sin(h), d = Math.cos(h);
        ...
        "use strict";
        var n = i(18), a = i(5), o = i(64), r = i(8), s = {M: 1, L: 2, C: 3, Q: 4, A: 5, Z: 6, R: 7}, l = [], h = [], u = [],
            c = [], d = Math.min, f = Math.max, p = Math.cos, g = Math.sin, m = Math.sqrt, v = "undefined" != typeof Float32Array,
            y = function () {
        ...
        y.prototype = {
            constructor: y, _lineDash: null, _dashOffset: 0, _dashIdx: 0, _dashSum: 0, getContext: function () {
                ...
                var i, n, a = this._dashSum, o = this._dashOffset, r = this._lineDash, s = this._ctx, l = this._xi, h = this._yi,
                    u = t - l, c = e - h, p = m(u * u + c * c), g = l, v = h, y = r.length;
                ...
                var s, l, h, u, c, d = this._dashSum, f = this._dashOffset, p = this._lineDash, g = this._ctx, v = this._xi,
                    y = this._yi, x = n.cubicAt, _ = 0, w = this._dashIdx, b = p.length, M = 0;
                ...
                for (var t = this.data, e = 0, i = 0, n = 0, d = 0, f = 0; f < t.length;) {
                    ...
                    switch (1 == f && (e = t[f], i = t[f + 1], n = e, d = i), m) {
                        ...
                        case s.Q:
                            ...
                            break;
                        case s.A:
                            var v = t[f++], y = t[f++], x = t[f++], _ = t[f++], w = t[f++], b = t[f++] + w,
                                M = (t[f++], 1 - t[f++]);
                ...
                for (var e = this.data, i = 0; i < this._len;) {
                    ...
                    switch (n) {
                        ...
                        case s.Q:
                            ...
                            break;
                        case s.A:
                            var a = e[i++], o = e[i++], r = e[i++], l = e[i++], h = e[i++], u = e[i++], c = e[i++], d = e[i++],
                                f = r > l ? r : l, p = r > l ? 1 : r / l, g = r > l ? l / r : 1, m = Math.abs(r - l) > .001;
        ...
        function o(t, e, i) {
            t = t || [];
            var n = e.get("coordinateSystem"), o = m[n], r = f.get(n), s = o && o(t, e, i), d = s && s.dimensions;
            d || (d = r && r.dimensions || ["x", "y"], d = u(d, t, d.concat(["value"])));
            var v, y = s && s.categoryAxisModel, x = "ordinal" === d[0].type ? 0 : "ordinal" === d[1].type ? 1 : -1,
                _ = new h(d, e), w = l(s, t), b = y && a(t) ? function (t, e, i, n) {
                    return n === x ? i : g(p(t), d[n])
                } : function (t, e, i, n) {
                    var a = p(t), o = g(a && a[n], d[n]);
        ...
        var h = i(14), u = i(31), c = i(1), d = i(7), f = i(28), p = d.getDataItemValue, g = d.converDataValue, m = {
            cartesian2d: function (t, e, i) {
                var n = i.getComponent("xAxis", e.get("xAxisIndex")), a = i.getComponent("yAxis", e.get("yAxisIndex")),
                    o = n.get("type"), l = a.get("type"),
                ...
                var n = e.get("polarIndex") || 0, a = function (t) {
                    ...
                    l = i.findComponents({mainType: "radiusAxis", filter: a})[0], h = l.get("type"), c = o.get("type"),
        ...
        var o = i(1), r = i(15), s = i(2), l = i(7), h = i(167), u = o.each, c = l.eachAxisDim, d = s.extendComponentModel({
            type: "dataZoom",
        ...
        u._updateCommon = function (t, e, i) {
            var a = this.childAt(0), o = t.hostModel, s = t.getItemModel(e), u = s.getModel(c), g = t.getItemVisual(e, "color"),
                m = a.style, v = s.getModel(d).getItemStyle();
            ...
            null != _ && (m.opacity = _);
            for (var w, b = s.getModel(f), M = s.getModel(p), S = t.dimensions.slice(), A = S.pop(); "ordinal" === (w = t.getDimensionInfo(A).type) || "time" === w;) A = S.pop();
        ...
        function o(t, e, i) {
            var n, a, o = u(-t.rotation), r = i[0] > i[1], s = "start" === e && !r || "start" !== e && r;
        ...
        var p = {
            axisLine: function () {
                ...
                if (t.get("axisTick.show")) {
                    ...
                    this.group.add(s.mergePath(h, {style: a.getLineStyle(), z2: 2, silent: !0}))
                }
            }, axisLabel: function () {
                function t(t, e) {
                ...
                if (e.get("axisLabel.show")) {
                    var i = this.opt, o = e.axis, r = e.getModel("axisLabel"), h = r.getModel("textStyle"), u = r.get("margin"),
                        c = o.scale.getTicks(), f = e.getFormattedLabels(), p = i.labelRotation;
                    ...
                    for (var m = a(i, p, i.labelDirection), v = e.get("data"), y = [], x = e.get("silent"), _ = 0; _ < c.length; _++) if (!g(o, _, i.labelInterval)) {
                        ...
                        var b = w.getTextColor(), M = o.dataToCoord(c[_]), S = [M, i.labelOffset + i.labelDirection * u],
                            A = o.scale.getLabel(c[_]), I = new s.Text({
                                style: {
                                    text: f[_],
                    ...
                    if ("category" !== o.type) {
                        ...
                        if (e.getMax ? e.getMax() : e.get("max")) {
                            var L = y[y.length - 1], D = y[y.length - 2];
                            t(D, L) && (L.ignore = !0)
                        }
                    }
                }
        ...
        g.type = "grid", g.getRect = function () {
            ...
            h.each(this._axesList, function (t) {
                ...
                if ("cartesian2d" === a.get("coordinateSystem")) {
                    var o = a.get("xAxisIndex"), r = a.get("yAxisIndex"), s = t.getComponent("xAxis", o),
            ...
            if (x) {
                ...
                if (!L) {
                    ...
                    var H = function (t, e) {
                        ...
                        G = i, F = e;
                        var n = I[i + 1] - I[i];
                        if (0 !== n) if (O = (e - I[i]) / n, v) if (V = T[i], E = T[0 === i ? i : i - 1], N = T[i > x - 2 ? x - 1 : i + 1], B = T[i > x - 3 ? x - 1 : i + 2], b) u(E, V, N, B, O, O * O, O * O * O, d(t, a), A); else {
                            var l;
                            if (M) l = u(E, V, N, B, O, O * O, O * O * O, W, 1), l = f(W); else {
                                if (S) return r(V, N, O);
                                l = c(E, V, N, B, O, O * O, O * O * O)
                            }
                            p(t, a, l)
                        } else if (b) s(T[i], T[i + 1], O, d(t, a), A); else {
                            var l;
                            if (M) s(T[i], T[i + 1], O, W, 1), l = f(W); else {
        ...
        var n = i(5), a = i(18), o = {}, r = Math.min, s = Math.max, l = Math.sin, h = Math.cos, u = n.create(), c = n.create(),
            d = n.create(), f = 2 * Math.PI;
        ...
        o.fromCubic = function (t, e, i, n, o, l, h, u, c, d) {
            ...
            var c = a.quadraticExtremum, d = a.quadraticAt, f = s(r(c(t, i, o), 1), 0), p = s(r(c(e, n, l), 1), 0),
	 ...
	 */
        var a = i(58), o = i(15), r = i(127), s = i(130), l = i(131), h = !o.canvasSupported, u = {canvas: i(129)}, c = {},
            d = {};
        ...
        t.exports = n.extend({
            ...
            getMarkerPosition: function (t) {
                ...
                if (e) {
                    var i = e.dataToPoint(t), n = this.getData(), a = n.getLayout("offset"), o = n.getLayout("size"),
        ...
        a.extend(i(12).prototype, i(82)), t.exports = i(2).extendChartView({
            type: "bar", render: function (t, e, i) {
                ...
                e.eachItemGraphicEl(function (r, s) {
                    ...
                    var p = i ? c.height > 0 ? "bottom" : "top" : c.width > 0 ? "left" : "right", g = l.getModel("label.normal"),
                        m = l.getModel("label.emphasis"), v = r.style;
        ...
        function s() {
            ...
            if (this.__dirty || e.__dirty) {
                var i = t.childOfName("fromSymbol"), n = t.childOfName("toSymbol"), a = t.childOfName("label"), o = e.pointAt(0),
                    s = e.pointAt(e.shape.percent), h = c.sub([], s, o);
        ...
        m.beforeUpdate = s, m._createLine = function (t, e, i, o) {
            ...
            var a = t.hostModel, o = this.childOfName("line"), r = t.getItemModel(n), s = r.getModel("label.normal"),
                l = s.getModel("textStyle"), h = r.getModel("label.emphasis"), u = h.getModel("textStyle"),
        ...
        function s(t, e) {
            var i = t.getBaseAxis(), n = t.getOtherAxis(i), a = i.onZero ? 0 : n.scale.getExtent()[0], o = n.dim,
                s = "x" === o || "radius" === o ? 1 : 0;
        ...
        function h(t, e, i) {
            var n = o(t.getAxis("x")), a = o(t.getAxis("y")), r = t.getBaseAxis().isHorizontal(), s = n[0], l = a[0],
                h = n[1] - s, u = a[1] - l;
        ...
        function u(t, e, i) {
            var n = t.getAngleAxis(), a = t.getRadiusAxis(), o = a.getExtent(), r = n.getExtent(), s = Math.PI / 180,
                l = new m.Sector({
                    shape: {
                        cx: t.cx,
                        cy: t.cy,
        ...
        t.exports = y.extend({
            type: "line", init: function () {
                ...
                var o = t.coordinateSystem, r = this.group, l = t.getData(), h = t.getModel("lineStyle.normal"),
                    u = t.getModel("areaStyle.normal"), f = l.mapArray(l.getItemLayout, !0), p = "polar" === o.type,
                    g = this._coordSys, m = this._symbolDraw, v = this._polyline, y = this._polygon, x = this._lineGroup,
                    _ = t.get("animation"), w = !u.isEmpty(), b = s(o, l), M = t.get("showSymbol"),
                    S = M && !p && !t.get("showAllSymbol") && this._getSymbolIgnoreFunc(l, o), A = this._data;
                ...
                var a = this._polyline, o = this._polygon, r = t.hostModel,
        ...
        h.updateData = function (t, e, i) {
            ...
            var i = this.childAt(1), n = this.childAt(2), a = t.hostModel, o = t.getItemModel(e), l = t.getItemLayout(e),
                h = l.label, u = t.getItemVisual(e, "color");
        ...
        t.exports = function (t, e, i, n) {
            ...
            l.each(function (i) {
                var n, a, c, d, f = l.getItemLayout(i), p = l.getItemModel(i), g = p.getModel("label.normal"),
                    m = g.get("position") || p.get("label.emphasis.position"), v = p.getModel("labelLine.normal"),
                    y = v.get("length"), x = v.get("length2"), _ = (f.startAngle + f.endAngle) / 2, w = Math.cos(_),
                    b = Math.sin(_);
                r = f.cx, s = f.cy;
                var M = "inside" === m || "inner" === m;
                if ("center" === m) n = f.cx, a = f.cy, d = "center"; else {
                    var S = (M ? (f.r + f.r0) / 2 * w : f.r * w) + r, A = (M ? (f.r + f.r0) / 2 * b : f.r * b) + s;
                    if (n = S + 3 * w, a = A + 3 * b, !M) {
                        var I = S + w * (y + e - f.r), T = A + b * (y + e - f.r), C = I + (0 > w ? -1 : 1) * x, L = T;
                        n = C + (0 > w ? -5 : 5), a = L, c = [[S, A], [I, T], [C, L]]
                    }
                    d = M ? "center" : w > 0 ? "left" : "right"
                }
                var D = g.getModel("textStyle").getFont(), P = g.get("rotate") ? 0 > w ? -_ + Math.PI : -_ : 0,
        ...
        t.exports = function (t, e, i) {
            e.eachSeriesByType(t, function (t) {
                ...
                var u = i.getWidth(), c = i.getHeight(), d = Math.min(u, c), f = a(e[0], u), p = a(e[1], c), g = a(h[0], d / 2),
                    m = a(h[1], d / 2), v = t.getData(), y = -t.get("startAngle") * l, x = t.get("minAngle") * l,
                    _ = v.getSum("value"), w = Math.PI / (_ || v.count()) * 2, b = t.get("clockwise"), M = t.get("roseType"),
        ...
        function n(t, e) {
            ...
            var n = t.coordinateSystem, a = e.axis, o = {}, r = a.position, s = a.onZero ? "onZero" : r, l = a.dim,
        ...
        var a = i(1), o = i(3), r = i(48), s = r.ifIgnoreOnTick, l = r.getInterval,
            h = ["axisLine", "axisLabel", "axisTick", "axisName"], u = ["splitLine", "splitArea"], c = i(2).extendComponentView({
                type: "axis", render: function (t, e) {
                    ...
                    var n = t.axis, r = t.getModel("splitLine"), h = r.getModel("lineStyle"), u = h.get("width"), c = h.get("color"),
                        d = l(r, i);
                    c = a.isArray(c) ? c : [c];
                    ...
                    for (var M = h.getLineStyle(), _ = 0; _ < g.length; _++) this.group.add(o.mergePath(g[_], {
                        style: a.defaults({stroke: c[_ % c.length]}, M),
                        silent: !0
                    }))
        ...
        var o = i(1), r = i(4), s = o.indexOf, l = o.curry, h = {min: l(a, "min"), max: l(a, "max"), average: l(a, "average")},
            u = function (t, e) {
        ...
        function a(t, e) {
            ...
            return r.each(i, function (t, e) {
                a[e] = {};
                var i = t.stacks, n = t.axis, o = n.getBandWidth(), s = l(t.categoryGap, o), h = l(t.gap, 1), u = t.remainedWidth,
                    c = t.autoWidthCount, d = (u - s) / (c + (c - 1) * h);
        ...
        function o(t, e, i) {
            ...
            e.eachSeriesByType(t, function (t) {
                var e = t.getData(), i = t.coordinateSystem, a = i.getBaseAxis(), r = n(t), l = o[a.index][r], h = l.offset,
                    u = l.width, c = i.getOtherAxis(a), d = t.get("barMinHeight") || 0,
                    f = a.onZero ? c.toGlobalCoord(c.dataToCoord(0)) : c.getGlobalExtent()[0], p = i.dataToPoints(e, !0);
        ...
        var c = i(1), d = i(7), f = i(12), p = c.each, g = c.filter, m = c.map, v = c.isArray, y = c.indexOf, x = c.isObject,
            _ = i(10), w = i(114), b = "\x00_ec_inner", M = f.extend({
        ...
        n.prototype = {
            constructor: n, setOption: function (t, e) {
                ...
                var e = this._api.getWidth(), i = this._api.getHeight(), n = this._mediaList, a = this._mediaDefault, r = [],
                    l = [];
        ...
        var r = i(1), s = i(121), l = [["x", "left"], ["y", "top"], ["x2", "right"], ["y2", "bottom"]],
        ...
        t.exports = function (t, e, a) {
            e.eachSeriesByType(t, function (t) {
                ...
                if ("cartesian2d" === o.type && a) {
                    var r = o.getBaseAxis(), s = o.getOtherAxis(r), l = r.getExtent(), h = l[1] - l[0],
        ...
        var n = i(1), a = i(32), o = i(4), r = i(37), s = a.prototype, l = r.prototype, h = Math.floor, u = Math.ceil,
            c = Math.pow, d = 10, f = Math.log, p = a.extend({
        ...
        var n = i(1), a = i(4), o = i(9), r = i(37), s = r.prototype, l = Math.ceil, h = Math.floor, u = 864e5,
            c = function (t, e, i, n) {
                for (; n > i;) {
                    var a = i + n >>> 1;
                    t[a][2] < e ? i = a + 1 : n = a
                ...
                type: "time", getLabel: function (t) {
                    ...
                    t = t || 10;
                    var e = this._extent, i = e[1] - e[0], n = i / t, o = f.length, r = c(f, n, 0, o), s = f[Math.min(r, o - 1)],
                        u = s[2];
                    if ("year" === s[0]) {
        ...
        var c = i(15), d = i(33), f = i(1), p = i(155), g = i(139), m = i(21),
        ...
        var y = ["touchstart", "touchend", "touchmove"], x = ["pointerdown", "pointerup", "pointermove"], _ = 300,
            w = d.addEventListener, b = d.removeEventListener, M = d.normalizeEvent, S = {
        ...
        s.prototype = {
            constructor: s, elCount: 0, __dirty: !0, initContext: function () {
                ...
                var e = this.dom, i = this.ctx, n = e.width, a = e.height, o = this.clearColor, r = this.motionBlur && !t,
        ...
        var u = i(42), c = i(1), d = i(45), f = i(8), p = i(128), g = new f(0, 0, 0, 0), m = new f(0, 0, 0, 0),
            v = function (t, e, i) {
            ...
            for (var u = 0, p = 0, g = 0, y = 0, x = 0, _ = 0; _ < t.length;) {
                ...
                switch (1 == _ && (p = t[_], g = t[_ + 1], y = p, x = g), w) {
                    ...
                    case h.Q:
                        ...
                        break;
                    case h.A:
                        var b = t[_++], M = t[_++], S = t[_++], A = t[_++], I = t[_++], T = t[_++], C = (t[_++], 1 - t[_++]),
                            L = Math.cos(I) * S + b, D = Math.sin(I) * A + M;
        ...
        var h = i(27).CMD, u = i(136), c = i(135), d = i(138), f = i(134), p = i(57).normalizeRadian, g = i(18), m = i(75),
            v = u.containStroke, y = 2 * Math.PI, x = 1e-4, _ = [-1, -1, -1], w = [-1, -1];
        t.exports = {
        ...
        t.exports = i(6).extend({
            ...
            buildPath: function (t, e) {
                var i = e.cx, n = e.cy, a = Math.max(e.r, 0), o = e.startAngle, r = e.endAngle, s = e.clockwise, l = Math.cos(o),
                    h = Math.sin(o);
        ...
        t.exports = i(6).extend({
            ...
            buildPath: function (t, e) {
                var i = e.cx, n = e.cy, a = Math.max(e.r0 || 0, 0), o = Math.max(e.r, 0), r = e.startAngle, s = e.endAngle,
                    l = e.clockwise, h = Math.cos(r), u = Math.sin(r);
        ...
        function n(t, e, i, n, a, o, r, s, l, h, u) {
            var g = l * (p / 180), y = f(g) * (t - i) / 2 + d(g) * (e - n) / 2, x = -1 * d(g) * (t - i) / 2 + f(g) * (e - n) / 2,
                _ = y * y / (r * r) + x * x / (s * s);
            _ > 1 && (r *= c(_), s *= c(_));
            var w = (a === o ? -1 : 1) * c((r * r * (s * s) - r * r * (x * x) - s * s * (y * y)) / (r * r * (x * x) + s * s * (y * y))) || 0,
                b = w * r * x / s, M = w * -s * y / r, S = (t + i) / 2 + f(g) * b - d(g) * M,
                A = (e + n) / 2 + d(g) * b + f(g) * M, I = v([1, 0], [(y - b) / r, (x - M) / s]), T = [(y - b) / r, (x - M) / s],
                C = [(-1 * y - b) / r, (-1 * x - M) / s], L = v(T, C);
        ...
        var r = i(6), s = i(27), l = i(157), h = i(19),
            ...
            for (o = 0, u = 0; o < f.length;) {
                switch (i = f[o++], u = o, n = 0, i) {
                    ...
                    case x:
                        ...
                        break;
                    case y:
                        var _ = e[4], w = e[5], b = l(e[0] * e[0] + e[1] * e[1]), M = l(e[2] * e[2] + e[3] * e[3]),
                            S = h(-e[1] / M, e[0] / b);
        ...
        var v = i(21), y = i(1), x = i(3), _ = y.bind, w = y.each, b = Math.min, M = Math.max, S = Math.pow, A = 1e4, I = 2,
        ...
        var C = {
            line: {
                ...
                create: p, getRanges: function () {
                    var t = m.call(this), e = [b(t[1][0], t[0][0]), b(t[1][1], t[0][1])],
        ...
        i(2).extendChartView({
            type: "scatter", init: function () {
                ...
                var n = t.getData(), a = this._largeSymbolDraw, o = this._normalSymbolDraw, r = this.group,
        ...
        function r(t, e) {
            ...
            if (n) {
                var o = e || 0 === n[0] && 100 === n[1], r = !e && l.getPixelPrecision(a, [0, 500]), s = !(e || 20 > r && r >= 0),
                    h = e || o || s;
        ...
        c.prototype = {
            constructor: c, hostedBy: function (t) {
                ...
                if (t === this._dataZoomModel) {
                    var i = this._dimName, n = this.getTargetSeriesModels(), a = t.get("filterMode"), o = this._valueWindow,
        ...
        var s = i(40), l = i(1), h = i(71), u = i(174), c = l.bind, d = s.extend({
        ...
        var n = i(39), a = (i(11), i(1), n.extend({
        ...
        var a = i(1), o = i(3), r = i(126), s = i(40), l = o.Rect, h = i(4), u = h.linearMap, c = i(11), d = i(71), f = h.asc,
            p = a.bind, g = Math.round, m = Math.max, v = a.each, y = 7, x = 1, _ = 30, w = "horizontal", b = "vertical", M = 5,
            S = ["line", "bar", "candlestick", "scatter"], A = s.extend({
                type: "dataZoom.slider", init: function (t, e) {
                    ...
                    var t = this.dataZoomModel, e = this.api, i = this._findCoordRect(),
                        n = {width: e.getWidth(), height: e.getHeight()}, o = this._orient === w ? {
                    ...
                    var t = this.group, e = this._location, i = this._orient, n = this.dataZoomModel.getFirstTargetAxisModel(),
                        a = n && n.get("inverse"), o = this._displayables.barGroup, r = (this._dataShadowInfo || {}).otherAxisInverse;
                    ...
                    if (t) {
                        var e = this._size, i = t.series, n = i.getRawData(), a = i.getShadowDim ? i.getShadowDim() : t.otherDim,
                            r = n.getDataExtent(a), s = .3 * (r[1] - r[0]);
                        r = [r[0] - s, r[1] + s];
                    ...
                    function t(t) {
                        var e = o.getTransform(i.handles[t], this.group), s = o.transformDirection(0 === t ? "right" : "left", e),
                            l = this._halfHandleSize + M, u = o.applyTransform([h[t] + (0 === t ? -l : l), this._size[1] / 2], e);
                        n[t].setStyle({
                            x: u[0],
                            y: u[1],
        ...
        var u = i(1), c = i(70), d = i(126), f = u.curry, p = "\x00_ec_dataZoom_roams", g = {
            register: function (t, e) {
                    ...
                    r.each(t.getData(), function (r) {
                        ...
                        if (!f[h]) if (p) {
                            ...
                            if (!f[h] && e.legendDataProvider) {
                                var s = e.legendDataProvider(), l = s.indexOfName(h), p = s.getItemVisual(l, "color"),
                                    g = "roundRect", m = this._createItem(h, r, t, g, null, d, p, c);
        ...
        var r = i(1), s = i(14), l = i(9), h = i(7), u = i(4), c = l.addCommas, d = l.encodeHTML, f = i(104), p = i(84),
            g = function (t, e, i, n) {
                var a = t.getData(), o = n.type;
                if (!r.isArray(n) && ("min" === o || "max" === o || "average" === o)) {
                    var s = f.getAxisInfo(n, a, e, t), l = s.baseAxis.dim + "Axis", h = s.valueAxis.dim + "Axis",
                        u = s.baseAxis.scale.getExtent(), c = r.clone(n), d = {};
        ...
        var o = i(38), r = i(1), s = i(9), l = i(7), h = i(4), u = s.addCommas, c = s.encodeHTML, d = i(14), f = i(104), p = {
            getRawDataArray: function () {
                return this.option.data
            }, formatTooltip: function (t) {
        ...
        n.extendComponentModel({
            ...
            type: "title", render: function (t, e, i) {
                if (this.group.removeAll(), t.get("show")) {
                    var n = this.group, r = t.getModel("textStyle"), s = t.getModel("subtextStyle"), l = t.get("textAlign"),
                        h = new a.Text({
                            style: {
                                text: t.get("text"),
                                textFont: r.getFont(),
            ...
            t.exports = i(2).extendComponentView({
                type: "toolbox", render: function (t, e, i) {
                    ...
                    if (f.removeAll(), t.get("show")) {
                        var p = +t.get("itemSize"), g = t.get("feature") || {}, m = this._features || (this._features = {}),
                            v = [];
                        o.each(g, function (t, e) {
                            ...
                            if (n && e) {
                                var a = u.getBoundingRect(e, n.font), o = t.position[0] + f.position[0],
            ...
            return t.eachRawSeries(function (t) {
                ...
                if (!a || "cartesian2d" !== a.type && "polar" !== a.type) i.push(t); else {
                    ...
                    if ("category" === o.type) {
                        ...
                        e[r] || (e[r] = {categoryAxis: o, valueAxis: a.getOtherAxis(o), series: []}, n.push({
                            axisDim: o.dim,
                            axisIndex: o.index
                        })), e[r].series.push(t)
                    } else i.push(t)
        ...
        d.defaultOption = {
            ...
            var w = "float:right;margin-right:20px;border:none;cursor:pointer;padding:2px 5px;font-size:12px;border-radius:3px",
                b = document.createElement("div"), M = document.createElement("div");
        ...
        function r(t, e) {
            ...
            if (n.intersect(i.getRect())) {
                var a = i.getCartesian(e[0].axisIndex, e[1].axisIndex), o = a.pointToData([t[0][0], t[1][0]], !0),
        ...
        o.onclick = function (t, e) {
            var i = this.model, n = i.get("name") || t.get("title.0.text") || "echarts", a = document.createElement("a"),
                o = i.get("type", !0) || "png";
        ...
        function o(t) {
            t = t;
            var e = [], i = t.get("transitionDuration"), o = t.get("backgroundColor"), r = t.getModel("textStyle"),
                s = t.get("padding");
            ...
            }), e.push(a(r)), null != s && e.push("padding:" + c.normalizeCssArray(s).join("px ") + "px"),
            e.join(";") + ";"
        }
        ...
        var l = i(1), h = i(22), u = i(33), c = i(9), d = l.each, f = c.toCamelCase, p = ["", "-webkit-", "-moz-", "-o-"],
        ...
        i(2).extendComponentView({
            type: "tooltip", _axisPointers: {}, init: function (t, e) {
                ...
                function s(i, n, a) {
                    var r = e.getAxis(i), s = r.getBandWidth(), h = a[1] - a[0],
                ...
                if (u.payloadBatch && !a && c.dispatchAction({
                    ...
                    }), a || (c.dispatchAction({type: "highlight", batch: l}), u.payloadBatch = l), c.dispatchAction({
                        type: "showTip",
                ...
                var n = this._api, a = t.getData(), o = a.getItemModel(e), r = this._tooltipModel, s = this._tooltipContent,
        ...
        if (!i(15).canvasSupported) {
            var n = i(5), a = i(8), o = i(27).CMD, r = i(22), s = i(17), l = i(66), h = i(35), u = i(46), c = i(65), d = i(6),
                f = i(16), p = i(158), g = Math.round, m = Math.sqrt, v = Math.abs, y = Math.cos, x = Math.sin, _ = Math.max,
                w = n.applyTransform, b = ",", M = "progid:DXImageTransform.Microsoft", S = 21600, A = S / 2, I = 1e5, T = 1e3,
                C = function (t) {
                    ...
                    for (r = 0; r < t.length;) {
                        switch (a = t[r++], n = "", i = 0, a) {
                            ...
                            case d:
                                ...
                                var R = t[r++], O = t[r++], E = t[r++], V = t[r++], N = t[r++] + z, B = t[r++] + N + z;
                                r++;
                                var F = t[r++], W = R + y(N) * E, H = O + x(N) * V, M = R + y(B) * E, I = O + x(B) * V,
                                    Z = F ? " wa " : " at ";
            ...
            u.prototype.brushVML = function (t) {
                ...
                if (a) {
                    var h = n.x || 0, u = n.y || 0, c = n.width, d = n.height, f = n.sWidth, v = n.sHeight, y = n.sx || 0,
                        x = n.sy || 0, S = f && v, A = this._vmlEl;
                    ...
                    if (this.transform && (I = this.transform, D = m(I[0] * I[0] + I[1] * I[1]), k = m(I[2] * I[2] + I[3] * I[3]), L = I[1] || I[2]), L) {
                        var R = [h, u], O = [h + c, u], E = [h, u + d], V = [h + c, u + d];
                        w(R, R, I), w(O, O, I), w(E, E, I), w(V, V, I);
                        var N = _(R[0], O[0], E[0], V[0]), B = _(R[1], O[1], E[1], V[1]), G = [];
            ...
            for (var K = new a, Q = function (t, e, i, n) {
                ...
                if (o) {
                    var r, l, h = a.textAlign, u = Y(a.textFont),
                        c = u.style + " " + u.variant + " " + u.weight + " " + u.size + 'px "' + u.family + '"',
                        d = a.textBaseline, f = a.textVerticalAlign;
        ...
        t.exports = function (t) {
            ...
            if (!e || "view" === e.type) {
                var i = e.getBoundingRect(), n = t.getData(), a = n.graph, o = 0, r = n.getSum("value"),
                    s = 2 * Math.PI / (r || n.count()), l = i.width / 2 + i.x, h = i.height / 2 + i.y,
                ...
                a.eachNode(function (t) {
                    ...
                    var e, i = t.getModel().get("lineStyle.normal.curveness") || 0, n = t.node1.getLayout(),
                        a = t.node2.getLayout();
        ...
        r.prototype = {
            constructor: r, draw: function (t, e, i, r) {
                ...
                var f, p, g, m, v, y, x = ["itemStyle", "normal"], _ = ["itemStyle", "emphasis"], w = ["label", "normal"],
                    b = ["label", "emphasis"];
                s || (f = t.getModel(x), p = t.getModel(_), g = n(f, d), m = n(p, d), v = t.getModel(w), y = t.getModel(b)), h.each(u.regions, function (e) {
                    ...
                    if (!s || I && (S || A) || T && T.showLabel) {
                        var C = s ? i : e.name, L = t.getFormattedLabel(C, "normal"), D = t.getFormattedLabel(C, "emphasis"),
                            P = new l.Text({
                                style: {
                                    text: S ? L || e.name : "",
                                    fill: u.getTextColor(),
                                ...
                                hoverStyle: {text: A ? D || e.name : "", fill: M.getTextColor(), textFont: M.getFont()},
        ...
        var a = i(1), o = i(15), r = i(2), s = i(7), l = i(347), h = i(73), u = h.mapVisual, c = h.eachVisual, d = i(4),
            f = a.isArray, p = a.each, g = d.asc, m = d.linearMap, v = r.extendComponentModel({
                type: "visualMap",
                dependencies: ["series"],
                dataBound: [-(1 / 0), 1 / 0],
                ...
                resetVisual: function (t) {
                    function e(e, o) {
                        p(this.stateList, function (r) {
                            var s = o[r] || (o[r] = i()), l = this.option[e][r] || {};
                            p(l, function (i, o) {
                                if (h.isValidType(o)) {
                ...
                completeVisualOption: function () {
                    ...
                    function i(t) {
                        var e = (t.inRange || {}).symbol || (t.outOfRange || {}).symbol,
                            i = (t.inRange || {}).symbolSize || (t.outOfRange || {}).symbolSize, n = this.get("inactiveColor");
                    ...
                    var n = this.option, o = {inRange: n.inRange, outOfRange: n.outOfRange}, r = n.target || (n.target = {}),
        ...
        t.exports = n.extendComponentView({
            ...
            getControllerVisual: function (t, e, i) {
                ...
                i = i || {};
                var r = i.forceState, s = this.visualMapModel, h = a.isArray(t);
                ...
                var d = s.controllerVisuals[r || s.getValueState(t)], f = l.prepareVisualTypes(d);
        ...
        "use strict";
        var n = i(1), a = i(13), o = i(159), r = a.extend({
            type: "series.boxplot",
        ...
        function n(t, e, i) {
            var n = e.getItemModel(i), a = n.getModel(h), o = e.getItemVisual(i, "color"), s = a.getItemStyle(["borderColor"]),
        ...
        var a = i(1), o = i(25), r = i(3), s = i(159), l = o.extend({
        ...
        function o(t, e, i) {
            ...
            a.each(o, function () {
                ...
                var h = arguments, u = o.length, c = h[0], d = h[u], f = "horizontal" === r ? 0 : 1, p = 1 - f, g = t(h[3]),
                    m = t(h[1]), v = t(h[5]), y = [[m, t(h[2])], [v, t(h[4])]];
                l(m), l(v), l(g);
                var x = [];
        ...
        "use strict";
        var n = i(1), a = i(13), o = i(159), r = i(9), s = r.encodeHTML, l = r.addCommas, h = a.extend({
        ...
        function n(t, e, i) {
            var n = e.getItemModel(i), a = n.getModel(h), o = e.getItemVisual(i, "color"), s = e.getItemVisual(i, "borderColor"),
                l = a.getItemStyle(["color", "color0", "borderColor", "borderColor0"]), c = t.childAt(t.whiskerIndex);
        ...
        t.exports = function (t, e) {
            t.eachSeriesByType("candlestick", function (t) {
                ...
                n.each(a, function () {
                    ...
                    var s = arguments, l = a.length, h = s[0], u = s[l], c = "horizontal" === o ? 0 : 1, d = 1 - c, f = s[1],
                        p = s[2], g = s[3], m = s[4], v = Math.min(f, p), y = Math.max(f, p), x = t(v), _ = t(y), w = t(g),
                        b = t(m), M = [[b, _], [w, x]], S = [];
        ...
        var i = ["itemStyle", "normal", "borderColor"], n = ["itemStyle", "normal", "borderColor0"],
            a = ["itemStyle", "normal", "color"], o = ["itemStyle", "normal", "color0"];
        t.exports = function (t, e) {
        ...
        s.updateData = function (t, e, i) {
            ...
            u = null == u ? 1 : u, i ? (n.setShape({points: h.points}), n.setStyle({opacity: 0}), o.initProps(n, {style: {opacity: u}}, a)) : o.updateProps(n, {
                style: {opacity: u},
                shape: {points: h.points}
            }, a);
            var c = s.getModel("itemStyle"), d = t.getItemVisual(e, "color");
            n.setStyle(r.defaults({fill: d}, c.getModel("normal").getItemStyle(["opacity"]))), n.hoverStyle = c.getModel("emphasis").getItemStyle(), this._updateLabel(t, e), o.setHoverStyle(this)
        }, s._updateLabel = function (t, e) {
            var i = this.childAt(1), n = this.childAt(2), r = t.hostModel, s = t.getItemModel(e), l = t.getItemLayout(e),
                h = l.label, u = t.getItemVisual(e, "color");
        ...
        function o(t) {
            t.each(function (e) {
                var i, n, a, o, r = t.getItemModel(e), s = r.getModel("label.normal"), l = s.get("position"),
        ...
        t.exports = function (t, e) {
            t.eachSeriesByType("funnel", function (t) {
                var i = t.getData(), r = t.get("sort"), h = n(t, e), u = a(i, r),
                ...
                var g = t.get("funnelAlign"), m = t.get("gap"), v = (h.height - m * (i.count() - 1)) / i.count(), y = h.y,
                    x = function (t, e) {
        ...
        function n(t, e) {
            var i = t.get("center"), n = e.getWidth(), a = e.getHeight(), o = Math.min(n, a), r = l(i[0], e.getWidth()),
                s = l(i[1], e.getHeight()), h = l(t.get("radius"), o / 2);
        ...
        var o = i(245), r = i(3), s = i(4), l = s.parsePercent, h = 2 * Math.PI, u = i(25).extend({
            type: "gauge", render: function (t, e, i) {
                ...
                for (var d = this.group, f = o.cx, p = o.cy, g = o.r, m = t.get("min"), v = t.get("max"), y = t.getModel("splitLine"), x = t.getModel("axisTick"), _ = t.getModel("axisLabel"), w = t.get("splitNumber"), b = x.get("splitNumber"), M = l(y.get("length"), g), S = l(x.get("length"), g), A = h, I = (u - h) / w, T = I / b, C = y.getModel("lineStyle").getLineStyle(), L = x.getModel("lineStyle").getLineStyle(), D = _.getModel("textStyle"), P = 0; w >= P; P++) {
                    ...
                    if (y.get("show")) {
                        var R = new r.Line({
                            shape: {x1: k * g + f, y1: z * g + p, x2: k * (g - M) + f, y2: z * (g - M) + p},
                            style: C,
                            silent: !0
                        });
                    ...
                    if (_.get("show")) {
                        var O = a(s.round(P / w * (v - m) + m), _.get("formatter")), E = new r.Text({
                            style: {
                                text: O,
                                x: k * (g - M - 5) + f,
                                y: z * (g - M - 5) + p,
                        ...
                        "auto" === E.style.fill && E.setStyle({fill: n(P / w)}), d.add(E)
                    }
                    if (x.get("show") && P !== w) {
                        for (var V = 0; b >= V; V++) {
                ...
                if (o.get("show")) {
                    var s = o.getModel("textStyle"), h = o.get("offsetCenter"), u = a.cx + l(h[0], a.r), c = a.cy + l(h[1], a.r),
                        d = new r.Text({
                            style: {
                                x: u,
                                y: c,
                ...
                if (s.get("show")) {
                    var c = s.getModel("textStyle"), d = s.get("offsetCenter"), f = o.cx + l(d[0], o.r), p = o.cy + l(d[1], o.r),
                        g = l(s.get("width"), o.r), m = l(s.get("height"), o.r), v = t.getData().get("value", 0), y = new r.Rect({
                            shape: {x: f - g / 2, y: p - m / 2, width: g, height: m},
                            style: {
        ...
        t.exports = i(6).extend({
            ...
            buildPath: function (t, e) {
                var i = Math.cos, n = Math.sin, a = e.r, o = e.width, r = e.angle, s = e.x - i(r) * o * (o >= a / 3 ? 1 : 2),
        ...
        "use strict";
        var n = i(14), a = i(1), o = i(209), r = i(2).extendSeriesModel({
            type: "series.graph",
            init: function (t) {
                r.superApply(this, "init", arguments), this.legendDataProvider = function () {
            ...
            type: "graph", init: function (t, e) {
                ...
                if ("geo" === n.type || "view" === n.type) {
                    ...
                    c.formatTooltip = function (t) {
                        var e = this.getDataParams(t), i = a.graph.getEdgeByIndex(t), n = a.getName(i.node1.dataIndex),
                            o = a.getName(i.node2.dataIndex), r = n + " > " + o;
                ...
                var t = this._model, e = t.getData(), i = this.group, n = this._nodeScaleRatio, a = i.scale[0],
                    o = (a - 1) * n + 1, r = [o / a, o / a];
        ...
        t.exports = function (t, e) {
            t.eachSeriesByType("graph", function (t) {
                if ("force" === t.get("layout")) {
                    var e = t.preservedPoints || {}, i = t.getGraph(), l = i.data, h = i.edgeData, u = t.getModel("force"),
                        c = u.get("initLayout");
                    t.preservedPoints ? l.each(function (t) {
                        var i = l.getId(t);
                        l.setItemLayout(t, e[i] || [NaN, NaN])
                    }) : c && "none" !== c ? "circular" === c && r(t) : o(t);
                    var d = l.getDataExtent("value"), f = u.get("repulsion"), p = u.get("edgeLength"),
                        ...
                        }), v = t.coordinateSystem, y = v.getBoundingRect(), x = n(g, m, {rect: y, gravity: u.get("gravity")}),
                        _ = x.step;
                    x.step = function (t) {
        ...
        n.prototype = {
            update: function (t, e, i, n, o, r) {
                var s = this._getBrush(), l = this._getGradient(t, o, "inRange"), h = this._getGradient(t, o, "outOfRange"),
                    u = this.pointSize + this.blurSize, c = this.canvas, d = c.getContext("2d"), f = t.length;
        ...
        t.exports = i(2).extendChartView({
            type: "heatmap", render: function (t, e, i) {
                ...
                d.applyTransform(f);
                var p = Math.max(d.x, 0), g = Math.max(d.y, 0), m = Math.min(d.width + d.x, o.getWidth()),
                    v = Math.min(d.height + d.y, o.getHeight()), y = m - p, x = v - g,
        ...
        function o() {
            var t = this.__p1, e = this.__p2, i = this.__cp1, n = this.__t, a = this.position, o = u.quadraticAt,
        ...
        d.stopEffectAnimation = function () {
            ...
            var p = o.get("showEffectOn"), g = s.get("rippleEffect.scale"), m = s.get("rippleEffect.brushType"),
        ...
        t.exports = function (t) {
            t.eachSeriesByType("lines", function (t) {
                ...
                i.each(o, function (t, n, a) {
                    ...
                    var e, o = i.getItemLayout(t), r = n.getItemLayout(t),
        ...
        var a = i(14), o = i(2), r = i(13), s = i(1), l = i(31), h = i(9), u = h.encodeHTML, c = h.addCommas, d = i(69),
            f = r.extend({
                type: "series.map",
                needsDrawMap: !1,
                seriesGroup: [],
                ...
                _fillOption: function (t) {
                    t = s.extend({}, t);
                    var e = o.getMap(t.map), i = e && e.geoJson;
                ...
                defaultOption: {
                    ...
                    roamDetail: {x: 0, y: 0, zoom: 1},
                    scaleLimit: null,
                    label: {normal: {show: !1, textStyle: {color: "#000"}}, emphasis: {show: !1, textStyle: {color: "#000"}}},
                    itemStyle: {
                ...
                a.each("value", function (t, e) {
                    if (!isNaN(t)) {
                        ...
                        if (i && i.point) {
                            ...
                            if (!s) {
                                var h = a.getName(e), u = a.getItemModel(e), c = u.getModel("label.normal"),
                                    d = u.getModel("label.emphasis"), f = c.getModel("textStyle"), p = d.getModel("textStyle"),
        ...
        t.exports = r.extend({
            ...
            getInitialData: function (t, e) {
                var i = e.getComponent("parallel", this.get("parallelIndex")), r = i.dimensions, s = i.parallelAxisIndex,
                    l = t.data, h = o.map(r, function (t, i) {
        ...
        function n(t, e, i) {
            var n = t.model, a = t.getRect(), o = new s.Rect({shape: {x: a.x, y: a.y, width: a.width, height: a.height}}),
        ...
        t.exports = function (t, e) {
            t.eachSeriesByType("parallel", function (e) {
                var i = e.getModel("itemStyle.normal"), n = t.get("color"), a = i.get("color") || n[e.seriesIndex % n.length],
                    o = e.get("inactiveOpacity"), r = e.get("activeOpacity"), s = e.getModel("lineStyle.normal").getLineStyle(),
                    l = e.coordinateSystem, h = e.getData(), u = {normal: s.opacity, active: r, inactive: o};
        ...
        t.exports = i(2).extendChartView({
            type: "radar", render: function (t, e, i) {
                ...
                d.diff(f).add(function (e) {
                    ...
                    var n = f.getItemGraphicEl(i), o = n.childAt(0), r = n.childAt(1), s = n.childAt(2),
        ...
        t.exports = i(2).extendChartView({
            type: "sankey", _model: null, render: function (t, e, i) {
                ...
                f.formatTooltip = function (t) {
                    ...
                    var i = e.getLayout(), n = e.getModel(), o = n.getModel("label.normal"), s = o.getModel("textStyle"),
                        l = n.getModel("label.emphasis"), u = l.getModel("textStyle"), c = new a.Rect({
                    ...
                    var i = t.getModel("lineStyle.normal"), n = i.get("curveness"), o = t.node1.getLayout(),
                        r = t.node2.getLayout(), l = t.getLayout();
                    e.shape.extent = Math.max(1, l.dy);
                    var u = o.x + o.dx, c = o.y + l.sy + l.dy / 2, d = r.x, p = r.y + l.ty + l.dy / 2, g = u * (1 - n) + d * n,
                        m = c, v = u * n + d * (1 - n), y = p;
                    e.setShape({
                        x1: u,
                        y1: c,
        ...
        var a = i(1), o = i(3), r = i(52), s = i(95), l = i(290), h = i(70), u = i(8), c = i(19), d = i(345), f = a.bind,
            p = o.Group, g = o.Rect, m = a.each, v = 3;
        t.exports = i(2).extendChartView({
            type: "treemap", init: function (t, e) {
                ...
                if (!(a.indexOf(o, t) < 0)) {
                    ...
                    var r = s.retrieveTargetInfo(n, t), l = n && n.type, h = t.layoutInfo, u = !this._oldTree, c = this._storage,
                        d = "treemapRootToNode" === l && r && c ? {
                            rootNodeGroup: c.nodeGroup[r.node.getRawIndex()],
                            direction: n.direction
                        } : null, f = this._giveContainerGroup(h), p = this._doRender(f, t, d);
                ...
                var u = e.getData().tree, c = this._oldTree, d = n(), p = n(), g = this._storage, v = [], y = [], x = [],
                    _ = f(this._renderNode, this, p, g, i, d, v, y), w = e.getViewRoot(), b = s.getPathToRoot(w);
                ...
                var v = l && l.getRawIndex(), y = h && h.getRawIndex(), x = l.getLayout(), _ = x.width, w = x.height,
                    b = x.invisible, M = c("nodeGroup", p);
                if (M) {
                    ...
                    if (!A || !A.length) {
                        ...
                        if (T) {
                            var C = Math.max(_ - 2 * I, 0), L = Math.max(w - 2 * I, 0), D = l.getModel("label.normal"),
                                P = l.getModel("label.normal.textStyle"), k = l.getModel("itemStyle.emphasis").getItemStyle(),
                                z = l.getModel().get("name"), R = P.getTextRect(z), O = D.get("show");
                    ...
                    m(e.willDeleteEls, function (t, e) {
                        m(t, function (t, e) {
                            ...
                            if (!t.invisible && (i = t.__tmWillDelete)) {
                                ...
                                }, t.z = 2) : (a = {style: {opacity: 0}}, t.z = 1); else {
                                    var h = 0, u = 0;
                    ...
                    if (e) {
                        ...
                        if (i) {
                            ...
                            if (n.getLayout().isLeafRoot) this._rootToNode(i); else if ("zoomToNode" === e) this._zoomToNode(i); else if ("link" === e) {
                                var a = n.hostTree.data.getItemModel(n.dataIndex), o = a.get("link", !0),
        ...
        function n(t, e, i) {
            ...
            t.eachComponent(n, function (t) {
                var n = e.getWidth(), o = e.getHeight(), r = t.option, s = r.size || [], l = _(w(r.width, s[0]), n),
                    h = _(w(r.height, s[1]), o),
                    u = y.getLayoutRect(t.getBoxLayoutParams(), {width: e.getWidth(), height: e.getHeight()}), p = i && i.type,
                    g = x.retrieveTargetInfo(i, t), m = "treemapRender" === p || "treemapMove" === p ? i.rootRect : null,
                    v = t.getViewRoot();
                if ("treemapMove" !== p) {
        ...
        function a(t, e, i, n) {
            ...
            if (!t.isRemoved()) {
                ...
                var c = t.getModel("itemStyle.normal"), d = c.get("borderWidth"), f = c.get("gapWidth") / 2, m = d - f,
                    v = t.getModel();
        ...
        function u(t, e, i, n, a) {
            var o = e === i.width ? 0 : 1, r = 1 - o, s = ["x", "y"], l = ["width", "height"], h = i[s[o]],
                u = e ? t.area / e : 0;
            (a || u > i[l[r]]) && (u = i[l[r]]);
            for (var c = 0, d = t.length; d > c; c++) {
                var f = t[c], m = {}, v = u ? f.getLayout().area / u : 0, y = m[l[r]] = p(u - 2 * n, 0),
                    x = i[s[o]] + i[l[o]] - h, _ = c === d - 1 || v > x ? x : v, w = m[l[o]] = p(_ - 2 * n, 0);
        ...
        var p = Math.max, g = Math.min, m = i(1), v = i(4), y = i(11), x = i(95), _ = v.parsePercent, w = m.retrieve, b = i(8),
            x = i(95);
        t.exports = n
    }, function (t, e, i) {
        function n(t, e, i, s, h, c) {
            ...
            if (!p.invisible) {
                var m, v = t.getModel(g), y = i[t.depth], x = a(v, e, y, s), _ = v.get("borderColor"),
        ...
        function u(t, e, i, n, a, o) {
            var r = f.extend({}, e);
            if (a) {
                var s = a.type, l = "color" === s && a.__drColorMappingBy,
            ...
            type: "angleAxis", render: function (t, e) {
                if (this.group.removeAll(), t.get("show")) {
                    var i = e.getComponent("polar", t.get("polarIndex")), n = t.axis, o = i.coordinateSystem,
                        r = o.getRadiusAxis().getExtent(), l = n.getTicksCoords();
        ...
        var a = i(1), o = i(48), r = i(160), s = ["axisLine", "axisLabel", "axisTick", "axisName"], l = i(2).extendComponentView({
            type: "parallelAxis", _selectController: null, render: function (t, e, i, r) {
                if (!n(t, e, r) && (this.axisModel = t, this.api = i, this.group.removeAll(), t.get("show"))) {
                    var l = e.getComponent("parallel", t.get("parallelIndex")).coordinateSystem, h = t.getAreaSelectStyle(),
                        u = h.width, c = l.getAxisLayout(t.axis.dim),
                        d = a.extend({strokeContainThreshold: u, axisLineSilent: !(u > 0)}, c), f = new o(t, d);
                    a.each(s, f.add, f);
                    var p = f.getGroup();
        ...
        i(2).extendComponentView({
            type: "radiusAxis", render: function (t, e) {
                if (this.group.removeAll(), t.get("show")) {
                    var i = e.getComponent("polar", t.get("polarIndex")), o = i.coordinateSystem.getAngleAxis(), h = t.axis,
                        u = i.coordinateSystem, c = h.getTicksCoords(), d = o.getExtent()[0], f = h.getExtent(), p = n(u, t, d),
                        g = new r(t, p);
            ...
            type: "radar", render: function (t, e, i) {
                ...
                if (r.length) {
                    var s = t.get("shape"), l = t.getModel("splitLine"), h = t.getModel("splitArea"), u = l.getModel("lineStyle"),
                        c = h.getModel("areaStyle"), d = l.get("show"), f = h.get("show"), p = u.get("color"), g = c.get("color");
        ...
        var s = i(1), l = i(3), h = i(11), u = i(313), c = i(311), d = i(24), f = i(23), p = i(8), g = i(19), m = i(4), v = i(7),
            y = i(9), x = y.encodeHTML, _ = s.bind, w = s.each, b = Math.PI;
        t.exports = u.extend({
            type: "timeline.slider", init: function (t, e) {
                ...
                if (this.model = t, this.api = i, this.ecModel = e, this.group.removeAll(), t.get("show", !0)) {
                    var a = this._layout(t, i), o = this._createGroup("mainGroup"), r = this._createGroup("labelGroup"),
                ...
                var r = {horizontal: "center", vertical: i >= 0 || "+" === i ? "left" : "right"},
                    ...
                    l = {horizontal: 0, vertical: b / 2}, h = "vertical" === a ? o.height : o.width,
                ...
                var m, v, y, x, _ = u.get("position", !0), c = u.get("show", !0), w = c && u.get("showPlayBtn", !0),
                    M = c && u.get("showPrevBtn", !0), S = c && u.get("showNextBtn", !0), A = 0, I = h;
                ...
                w(r, function (t, n) {
                    var r = i.dataToCoord(t), h = a.getItemModel(n), u = h.getModel("itemStyle.normal"),
                        c = h.getModel("itemStyle.emphasis"), d = {position: [r, 0], onclick: _(this._changeTimeline, this, n)},
                        f = o(h, u, e, d);
                ...
                if (a.get("show")) {
                    var o = n.getData(), r = i.scale.getTicks(), s = f.getFormattedLabels(i, a.get("formatter")),
                        h = i.getLabelInterval();
                    w(r, function (n, a) {
                        if (!i.isLabelIgnored(a, h)) {
                            var r = o.getItemModel(a), u = r.getModel("label.normal.textStyle"),
        ...
        function a(t) {
            var e = t.itemStyle || (t.itemStyle = {}), i = e.emphasis || (e.emphasis = {}), n = t.label || t.label || {},
                a = n.normal || (n.normal = {}), s = {normal: 1, emphasis: 1};
        ...
        var o = i(213), r = i(3), s = i(1), l = i(4), h = i(71), u = l.linearMap, c = i(76), d = i(214), f = s.each,
            p = o.extend({
                type: "visualMap.continuous", init: function () {
                    ...
                    var e = this.visualMapModel, i = this._shapes, a = e.itemSize, o = this._orient, r = this._useHandle,
                        l = d.getItemAlign(e, this.api, a), h = i.barGroup = this._createBarGroup(l);
                    ...
                    var c = {
                        ...
                        silent: !0,
                        style: {x: 0, y: 0, text: "", textVerticalAlign: "middle", textFont: d.getFont(), fill: d.getTextColor()}
                    });
                    this.group.add(f);
                    var p = this._shapes;
                    ...
                    var e = this.visualMapModel, i = e.getExtent(), n = this._shapes, a = this._dataInterval,
                        o = [0, e.itemSize[1]], r = t ? o : this._handleEnds, s = this._createBarVisual(a, i, r, "inRange"),
                    ...
                    var a = {forceState: n, convertOpacityToAlpha: !0}, o = this.getControllerVisual(t, "color", a),
                        r = [this.getControllerVisual(t[0], "symbolSize", a), this.getControllerVisual(t[1], "symbolSize", a)],
                        s = this._createBarPoints(i, r);
                    return {barColor: new c(0, 0, 1, 1, o), barPoints: s, handlesColor: [o[0].color, o[o.length - 1].color]}
        ...
        var n = i(213), a = i(1), o = i(3), r = i(24), s = i(11), l = i(214), h = n.extend({
            type: "visualMap.piecewise", doRender: function () {
                ...
                var e = this.group;
                e.removeAll();
                var i = this.visualMapModel, n = i.get("textGap"), r = i.textStyleModel, l = r.getFont(), h = r.getTextColor(),
                    u = this._getItemAlign(), c = i.itemSize, d = this._getViewData(), f = !d.endsText, p = !f;
        ...
        n.prototype = {
            type: "parallel", constructor: n, _init: function (t, e, i) {
                ...
                u(n, function (t, i) {
                    var n = a[i], r = e.getComponent("parallelAxis", n),
                ...
                var e = this._rect, i = t.get("layout"), n = this._axesMap, a = this.dimensions, o = [e.width, e.height],
                    r = "horizontal" === i ? 0 : 1, s = o[r], h = o[1 - r], d = [0, h];
                u(n, function (t) {
                    var e = t.inverse ? 1 : 0;
                    t.setExtent(d[e], d[1 - e])
                }), u(a, function (t, n) {
                    var o = s * n / (a.length - 1), r = {horizontal: {x: o, y: h}, vertical: {x: 0, y: o}},
        ...
        o.prototype = {
            constructor: o, type: "polar", dimensions: ["radius", "angle"], containPoint: function (t) {
                ...
                var e = t[0] - this.cx, i = t[1] - this.cy, n = this.getAngleAxis(), a = n.getExtent(), o = Math.min(a[0], a[1]),
                    r = Math.max(a[0], a[1]);
        ...
        var a = i(72), o = a.valueAxis, r = i(12), s = i(1), l = i(49), h = i(2).extendComponentModel({
            type: "radar",
            optionUpdated: function () {
                var t = this.get("boundaryGap"), e = this.get("splitNumber"), i = this.get("scale"), n = this.get("axisLine"),
                    a = this.get("axisTick"), o = this.get("axisLabel"), h = this.get("name.textStyle"),
                    u = this.get("name.show"), c = this.get("name.formatter"), d = this.get("nameGap"),
